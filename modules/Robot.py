#Robotergruppe nach Bernauer und Asmus
...
__date__ = "2016/01/15"
#----------------------------------------#
#_ _ _ _ _ _ _ _ README _ _ _ _ _ _ _ _ _#
#										 #
#	 		  L2    L1					 #
#			  ||    ||					 #
#			 _||____||_					 #
...
#			  L4    L5					 #
#										 #
# [m/1k] |	a0	a1	a2	a3	a4	a5	a6	 #
# -------+-----------------------------	 #
#	L1	 |	41	38	50	60	22	05	97	 #
#	L2	 |	41	38	50	60	22	05	97	 #
#	L3	 |	31	38	50	60	22	05	97	 #
#	L4	 |	41	38	50	60	22	05	97	 #
#	L5	 |	41	38	50	60	22	05	97	 #
#	L6	 |	31	38	50	60	22	05	97	 #
#										 #
#----------------------------------------#
...
class Rob:
    ...
    def gangDreieck(ausgangshoehe,schritthoehe,verschiebungX):
        ...
        listeDreieck = [[0,0,ausgangshoehe,1],[-xHalb,0,ausgangshoehe,0],[0,0,schritthoehe,2],[xHalb,0,ausgangshoehe,0]]
        return(listeDreieck)
    #Funktion Rechteckgang
    def gangRechteck(ausgangshoehe,schritthoehe,verschiebungX):
        xHalb = verschiebungX/2
        listeRechteck = [[0,0,ausgangshoehe,1],[-xHalb,0,ausgangshoehe,0],[-xHalb,0,ausgangshoehe,0],[-xHalb,0,schritthoehe,0],[0,0,schritthoehe,2],[xHalb,0,schritthoehe,0],[xHalb,0,ausgangshoehe,0],[xHalb,0,ausgangshoehe,0]]
    ...
    def hochUndRunter(ausgangshoehe,schritthoehe,verschiebungX):
        listeHochUndRunter = [[0,0,ausgangshoehe,1],[0,0,schritthoehe,0],[0,0,ausgangshoehe,2],[0,0,schritthoehe,0]]
    ...
    def setPos(self,positionen,legOffset):
        koordinaten = [round(positionen[0]+legOffset[0],3),round(positionen[1]+legOffset[1],3),round(positionen[2]+legOffset[2],3)]
        return(koordinaten)
    ...
    initialPosFuesse = [[fuss1245X,-fuss1245Y,0,0],[fuss1245X,fuss1245Y,0,0],[fuss36X,fuss36Y,0,0],[-fuss1245X,fuss1245Y,0,0],[-fuss1245X,-fuss1245Y,0,0],[fuss36X,-fuss36Y,0,0]]
    ...
    def __init__(self,data):
        ...
        for i in range(0, 6):
            self.setLeg(i, [self.initialPosFuesse[i][0], self.initialPosFuesse[i][1], self.initialPosFuesse[i][2],1], self.speed)
...
#---#-------- BEWEGUNG ----------------------------------------------#
    ...
    def setLeg(self, index, fPos, speed = 15):
    ...
    # ================================================================#
    # Berechnet synchronisierte Beingeschwindigkeiten.		    	  #
    # ----------------------------------------------------------------#
    def legSpeed(self):
    ...
    def loop(self, run_event):
        ...
        while run_event.is_set():
            ...
            if self.workList[self.index1][3] == 1 and self.workList[self.index2][3] == 2:
                ...
                self.dictAbgleich()
                self.workList = copy.deepcopy(self.listeGangartenfunktionen[self.wahlGangart](self.ausgangshoeheZ, self.hoeheZ, self.verschiebungX))
                self.index1 = 0
            ...
            #print("Hoehe Fuss ", self.hoeheZ)
            #print("Hoehe Koerper ", self.ausgangshoeheZ)
            print("Schrittweite ",self.verschiebungX)
            print("geschwindigkeit ",self.speed)
            #print("Wahl Gang ", self.wahlGangart)
            ...
            #Optionale Pause
            delta2 = time()
            sleep((self.heartrate/2)-(delta2-delta1))
            #print("durchlauf")
            ...
            print()
            delta3 = time()
            sleep(self.heartrate-(delta3-delta1))

#Worker fuer Aufruf von Timo
